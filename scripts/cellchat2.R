...
datainput_single_multiple_sample_cellchat2<- function(index_single_sample_cellchat2_input,  index_s_cellchat11, index_s_cellchat12){
  ...
  plots606 <- scrdavis_cellchat_plot(function() {
    netVisual_aggregate(cellchat, signaling = index_s_cellchat11, layout = "circle", label.edge = index_s_cellchat12)
  })
  plots607 <- scrdavis_cellchat_plot(function() {
    netVisual_chord_gene(cellchat, signaling = index_s_cellchat11, lab.cex = 1)
  })
  ...
  plots609 <- scrdavis_cellchat_plot(function() {
    netVisual_aggregate(cellchat, signaling = index_s_cellchat11, layout = "hierarchy", vertex.receiver = vertex.receiver)
  })
